...
*(À insérer : diagramme montrant les acteurs (Utilisateur, Système) et les cas d'utilisation : Démarrer surveillance, Arrêter surveillance, Consulter statistiques, Accéder aux captures, Configurer paramètres)*

### **b) Diagramme de séquence (SysML)**

**Type :** Diagramme de séquence - Détection et capture

*(À insérer : diagramme montrant l'interaction entre Caméra → SurveillanceManager → DatabaseManager → MySQL lors d'une détection de mouvement)*
